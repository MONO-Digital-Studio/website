    ...
    <footer className="py-8 sm:py-10 md:py-12 relative bg-[#0D0208]/75 backdrop-blur-md border-t border-[#008F11]/30">
      <div className="container mx-auto px-3 sm:px-4">
        ...
        >
          ...
          <div>
            <h4 className="text-base sm:text-lg font-bold mb-3 sm:mb-4 text-[#00FF41] font-['Courier_Prime'] text-center">Услуги</h4>
            <ul className="space-y-1 sm:space-y-2 text-center">
              {[
                'Веб-разработка', 
                'UI/UX Дизайн', 
          ...
          <div className="col-span-2 sm:col-span-1">
            <h4 className="text-base sm:text-lg font-bold mb-3 sm:mb-4 text-[#00FF41] font-['Courier_Prime'] text-center">Еще Услуги</h4>
            <ul className="space-y-1 sm:space-y-2 text-center">
              {[
                'Digital маркетинг', 
                'ИИ решения',
